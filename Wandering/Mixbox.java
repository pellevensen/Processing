...
public final class Mixbox {
  ...
  public static float[] floatRgbToLatent(float r, float g, float b) {
    ...
    w = (1.0f-tx)*(1.0f-ty)*(1.0f-tz);
    c0 += w*(((int)lut[xyz+ 192])&0xFF);
    c1 += w*(((int)lut[xyz+262336])&0xFF);
    c2 += w*(((int)lut[xyz+524480])&0xFF);
    w = (     tx)*(1.0f-ty)*(1.0f-tz);
    c0 += w*(((int)lut[xyz+ 193])&0xFF);
    c1 += w*(((int)lut[xyz+262337])&0xFF);
    c2 += w*(((int)lut[xyz+524481])&0xFF);
    w = (1.0f-tx)*(     ty)*(1.0f-tz);
    c0 += w*(((int)lut[xyz+ 256])&0xFF);
    c1 += w*(((int)lut[xyz+262400])&0xFF);
    c2 += w*(((int)lut[xyz+524544])&0xFF);
    w = (     tx)*(     ty)*(1.0f-tz);
    c0 += w*(((int)lut[xyz+ 257])&0xFF);
    c1 += w*(((int)lut[xyz+262401])&0xFF);
    c2 += w*(((int)lut[xyz+524545])&0xFF);
    w = (1.0f-tx)*(1.0f-ty)*(     tz);
    c0 += w*(((int)lut[xyz+4288])&0xFF);
    c1 += w*(((int)lut[xyz+266432])&0xFF);
    c2 += w*(((int)lut[xyz+528576])&0xFF);
    w = (     tx)*(1.0f-ty)*(     tz);
    c0 += w*(((int)lut[xyz+4289])&0xFF);
    c1 += w*(((int)lut[xyz+266433])&0xFF);
    c2 += w*(((int)lut[xyz+528577])&0xFF);
    w = (1.0f-tx)*(     ty)*(     tz);
    c0 += w*(((int)lut[xyz+4352])&0xFF);
    c1 += w*(((int)lut[xyz+266496])&0xFF);
    c2 += w*(((int)lut[xyz+528640])&0xFF);
    w = (     tx)*(     ty)*(     tz);
    c0 += w*(((int)lut[xyz+4353])&0xFF);
    c1 += w*(((int)lut[xyz+266497])&0xFF);
    c2 += w*(((int)lut[xyz+528641])&0xFF);
